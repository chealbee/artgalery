...
const Paragraph = () => {
  ...
  const text = `Однак, ви не лише станете цього мистецтва – ви також матимете можливість самі створити щось унікальне. Наші майстри скульптури будуть присутні, щоб провести майстер-класи та допомогти вам втілити ваші ідеї в реальність.`;
